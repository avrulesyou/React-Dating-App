...
const DDOtherProfilesScreen = (props) => {
  const { theme } = props;
  const { navigation } = props;
  const {
    route: { params: pairIds },
  } = props;
  ...
  return (
    ...
    >
      ...
      <XanoAPIApi.FetchGetSingleDDTeamsRecordByUserIdPOST
        user_id={pairIds?.user_id ?? ""}
        user2_id={pairIds?.user2_id ?? ""}
      >
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  {fetchData?.group_prompt1_response}
                </Text>
              </View>
              {/* Second Group Pic */}
              <View
              ...
              >
                ...
                >
                  {fetchData?.group_prompt2_response}
                </Text>
              </View>
              {/* Third Group Pic */}
              <View
              ...
              >
                ...
                >
                  {fetchData?.group_prompt3_response}
                </Text>
              </View>
              {/* Fifth Group Pic */}
              <View
...
const styles = StyleSheet.create({
  ...
  Viewb3267adf: { flexDirection: "row", marginTop: 3 },
  Viewc88f7e60: {
    borderBottomWidth: 1,
    borderLeftWidth: 1,
    borderRightWidth: 1,
...
export default withTheme(DDOtherProfilesScreen);
