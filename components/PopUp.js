...
import { LinearGradient, Surface, Touchable, withTheme } from "@draftbit/ui";
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={styles.View059cfbad}>
            <Surface style={[styles.Surface9b87f518]}>
              <Touchable onPress={onPressFirst}>
                <LinearGradient
...
const styles = StyleSheet.create({
  MainView: { flex: 1, justifyContent: "center", marginHorizontal: 25 },
  Viewaabce009: {
    display: "flex",
